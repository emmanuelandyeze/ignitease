...
const Partners = () => {
    return (
			<div className="bg-[#F7F7F7] mt-20 md:mb-20 md:mt-20 flex justify-center items-center pt-5 pb-0 md:pt-10">
				<div>
					...
					<div className="flex flex-row gap-4 md:gap-[40px] max-w-5xl mx-auto mt-5 px-5 md:mt-5 justify-between items-center">
						<Image
							src="/images/ploutos-logo.png"
							alt="Ploutos"
							width={500}
							height={500}
